...
| `GEMINI_API_KEY` | STT, reasoning, embeddings, deep research |
...
Plain vars in `apps/agent/wrangler.jsonc`: `GEMINI_MODEL`, `GEMINI_LIVE_MODEL`,
`GEMINI_EMBEDDING_MODEL`, and `ELEVENLABS_TTS_MODEL`.
